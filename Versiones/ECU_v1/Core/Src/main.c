...
/*			 for (int i = 0; i <RxData[1]; i++){
	  	 ...
	  	 if (RxData[0] == 100){ //he pulsado el amarillo
	  		  TxData[0] = 50; //ms delay
	  		  TxData[1] = 10; //loop rep
	  	 } else  if (RxData[0] == 200){ //he pulsado el rojo
...
static void MX_CAN1_Init(void)
{
  ...
  CAN_FilterTypeDef canfilterconfig;
    ...
    canfilterconfig.FilterIdHigh = 0x558<<5;
    canfilterconfig.FilterIdLow = 0x0000;
    canfilterconfig.FilterMaskIdHigh = 0x558<<5; //Escribo en la posicion 5
